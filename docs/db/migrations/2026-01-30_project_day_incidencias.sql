-- 2026-01-30_project_day_incidencias.sql
-- Incidencias por dia de proyecto (minimo viable)

-- ==============================
-- 1) Tabla T_ProyectoDiaIncidencia
-- ==============================
CREATE TABLE IF NOT EXISTS T_ProyectoDiaIncidencia (
  PK_PDI_Cod INT AUTO_INCREMENT PRIMARY KEY,
  FK_PD_Cod INT NOT NULL,
  PDI_Tipo VARCHAR(50) NOT NULL,
  PDI_Descripcion VARCHAR(500) NOT NULL,

  FK_Em_Cod INT NULL,
  FK_Em_Reemplazo_Cod INT NULL,
  FK_Eq_Cod INT NULL,
  FK_Eq_Reemplazo_Cod INT NULL,
  FK_U_Cod INT NULL,
...
-- ==============================
-- 2) SP: obtener proyecto (agrega incidencias por dia)
-- ==============================
