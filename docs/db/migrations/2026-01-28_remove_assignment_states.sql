-- 2026-01-28_remove_assignment_states.sql
-- Eliminar estados de asignacion por dia (empleado/equipo)

-- ==============================
-- 1) Eliminar columnas de estado
-- ==============================
ALTER TABLE T_ProyectoDiaEmpleado
  DROP COLUMN PDE_Estado;

ALTER TABLE T_ProyectoDiaEquipo
  DROP COLUMN PDQ_Estado;

-- ==============================
-- 2) SP: disponibilidad (sin estados de asignacion)
-- ==============================
...
-- ==============================
-- 3) SP: obtener proyecto (sin estados de asignacion)
-- ==============================
