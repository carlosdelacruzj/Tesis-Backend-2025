...
(21, 1, 1, 'Fotografia Boda Deluxe', 2, 0, 1, '1500.00', 'Boda 8h con 1 fotografo y 1 asistente. Incluye galeria digital y photobook 30x30 (65 fotos).', '8.0', 65, 0, 0),
(22, 2, 1, 'Video Boda Deluxe', 2, 0, 1, '1250.00', 'Boda 8h con 1 camara y apoyo tecnico. Incluye resumen 2 min y video final de 50 min aprox.', '8.0', NULL, 2, 50);
...
(140, 21, 1, 2, '1 camara principal + 1 backup por servicio'),
(141, 21, 2, 2, 'Lentes base por cobertura'),
(142, 21, 4, 1, 'Flash principal'),
(143, 21, 5, 1, 'Tripode principal'),
(144, 21, 9, 1, 'Luz continua de apoyo'),
(145, 21, 10, 2, 'Baterias base + respaldo'),
(146, 21, 12, 1, 'Monopode'),
(147, 21, 14, 2, 'Tarjetas SD (respaldo)'),
(148, 22, 1, 2, '1 camara principal + 1 backup por servicio'),
(149, 22, 6, 1, 'Gimbal principal'),
(150, 22, 8, 2, 'Microfonos (solapa + ambiente)'),
(151, 22, 7, 1, 'Grabadora principal'),
(152, 22, 5, 1, 'Tripode principal'),
(153, 22, 9, 1, 'Luz continua de apoyo'),
(154, 22, 10, 2, 'Baterias base + respaldo'),
(155, 22, 12, 1, 'Monopode'),
(156, 22, 14, 2, 'Tarjetas SD (respaldo)'),
(157, 22, 15, 1, 'SSD (backup)');
