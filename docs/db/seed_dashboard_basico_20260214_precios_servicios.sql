...
(1, 1, 1, 'Fotografia Boda Standard', 1, 0, 1, '1100.00', 'Cobertura de boda por 8h con 1 fotografo. Incluye galeria digital y photobook 30x30 con 50 fotos.', '8.0', 50, 0, 0),
(2, 1, 1, 'Fotografia Boda Premium', 3, 0, 1, '1900.00', 'Cobertura de boda por 8h con 2 fotografos. Incluye galeria digital y photobook 30x30 con 80 fotos.', '8.0', 80, 0, 0),
(3, 2, 1, 'Video Boda Standard', 1, 0, 1, '900.00', 'Cobertura de boda por 8h con 1 camara. Entrega digital en HD con video final de aprox. 50 minutos.', '8.0', NULL, 0, 50),
(4, 2, 1, 'Video Boda Premium', 3, 0, 1, '1600.00', 'Cobertura de boda por 8h con 2 camaras. Incluye resumen de 3 min y video final de aprox. 50 minutos.', '8.0', NULL, 3, 50),
(5, 3, 1, 'Drone Boda Ceremonia', 5, 1, 1, '280.00', 'Tomas aereas puntuales para exteriores, llegada y bloques clave de ceremonia.', '2.0', NULL, NULL, NULL),
(6, 3, 1, 'Drone Boda Extendida', 5, 1, 1, '620.00', 'Cobertura aerea en multiples bloques del matrimonio con plan de vuelo coordinado.', '4.0', NULL, NULL, NULL),
(7, 4, 1, 'Photobooth Boda Social', 5, 1, 1, '550.00', 'Photobooth social por 3 horas con operador y galeria digital del evento.', '3.0', NULL, NULL, NULL),
(8, 1, 2, 'Fotografia Cumple Standard', 1, 0, 1, '800.00', 'Cobertura de cumpleanos por 4h con 1 fotografo y entrega digital.', '4.0', 0, NULL, NULL),
(9, 1, 2, 'Fotografia Cumple Premium', 3, 0, 1, '1400.00', 'Cobertura de cumpleanos por 6h con retratos familiares y seleccion curada.', '6.0', 30, NULL, NULL),
(10, 2, 2, 'Video Cumple Standard', 1, 0, 1, '900.00', 'Video de cumpleanos por 4h con resumen de momentos clave.', '4.0', NULL, 2, 12),
(11, 2, 2, 'Video Cumple Premium', 3, 0, 1, '1500.00', 'Cobertura de cumpleanos por 6h con enfoque narrativo y film extendido.', '6.0', NULL, 3, 20),
(12, 3, 2, 'Drone Cumple Show', 5, 1, 1, '320.00', 'Tomas aereas del show principal y apertura del evento.', '2.0', NULL, NULL, NULL),
(13, 4, 2, 'Photobooth Cumple Kids', 5, 1, 1, '600.00', 'Photobooth de 3 horas con flujo rapido y entrega digital.', '3.0', NULL, NULL, NULL),
(14, 1, 3, 'Fotografia Corporativa Retratos', 4, 0, 1, '900.00', 'Sesion de retratos ejecutivos en locacion con iluminacion controlada.', '3.0', NULL, NULL, NULL),
(15, 1, 3, 'Fotografia Corporativa Evento', 4, 0, 1, '2600.00', 'Cobertura de conferencia o lanzamiento con enfoque editorial.', '6.0', NULL, NULL, NULL),
(16, 2, 3, 'Video Corporativo Conferencia', 4, 0, 1, '3000.00', 'Registro multicamara de conferencia con edicion de resumen.', '6.0', NULL, 2, 25),
(17, 2, 3, 'Video Corporativo Institucional', 4, 0, 1, '3600.00', 'Produccion institucional con entrevistas y recursos de apoyo.', '8.0', NULL, 2, 12),
(18, 3, 3, 'Drone Corporativo Exterior', 5, 1, 1, '600.00', 'Tomas aereas de fachada, entorno y activos del cliente.', '3.0', NULL, NULL, NULL),
(19, 4, 3, 'Photobooth Corporativo Branding', 5, 1, 1, '850.00', 'Photobooth de marca con personal de apoyo y entrega en linea.', '3.0', NULL, NULL, NULL),
(20, 1, 2, 'Fotografia Cumpleanos Deluxe', 2, 0, 1, '1900.00', 'Cobertura de cumpleanos por 8h con 2 fotografos, asistente y entrega premium.', '8.0', 50, NULL, NULL),
(21, 1, 1, 'Fotografia Boda Deluxe', 2, 0, 1, '2300.00', 'Boda 8h con 3 fotografos y 1 asistente. Incluye galeria digital y photobook 30x30 (100 fotos).', '8.0', 100, 0, 0),
(22, 2, 1, 'Video Boda Deluxe', 2, 0, 1, '1900.00', 'Boda 8h con 2 videografos y 1 asistente. Incluye resumen 4 min y video final 60 min aprox.', '8.0', NULL, 4, 60);
ALTER TABLE `T_EventoServicio` AUTO_INCREMENT = 23;
...
(1, 1, 1, 2, '1 camara principal + 1 backup por servicio'),
(2, 1, 2, 2, 'Lentes base (24-70 y 70-200)'),
(3, 1, 4, 1, 'Flash principal'),
(4, 1, 5, 1, 'Tripode principal'),
(5, 1, 9, 1, 'Luz continua'),
(6, 1, 10, 2, 'Baterias base + respaldo'),
(7, 1, 14, 2, 'Tarjetas SD (respaldo)'),
(8, 2, 1, 3, '2 camaras de operacion + 1 backup'),
(9, 2, 2, 3, 'Lentes por operador + 1 respaldo'),
(10, 2, 4, 2, 'Flashes para cobertura principal'),
(11, 2, 5, 2, 'Tripodes de operacion'),
(12, 2, 9, 1, 'Luz continua de apoyo'),
(13, 2, 10, 3, 'Baterias base + 1 backup por servicio'),
(14, 2, 12, 1, 'Monopode'),
(15, 2, 14, 3, 'Tarjetas SD (respaldo)'),
(16, 3, 1, 2, '1 camara por operador + 1 backup por servicio'),
(17, 3, 6, 1, 'Gimbal principal'),
(18, 3, 8, 2, 'Microfonos (solapa + ambiente)'),
(19, 3, 7, 1, 'Grabadora principal'),
(20, 3, 5, 1, 'Tripode principal'),
...
(26, 4, 6, 1, 'Gimbal de apoyo'),
(27, 4, 8, 3, 'Microfonos para ceremonia y recepcion'),
(28, 4, 7, 1, 'Grabadora principal'),
(29, 4, 5, 2, 'Tripodes de operacion'),
(30, 4, 9, 2, 'Luces continuas de apoyo'),
(31, 4, 10, 3, 'Baterias base + 1 backup por servicio'),
(32, 4, 12, 1, 'Monopode'),
(34, 4, 14, 3, 'Tarjetas SD (respaldo)'),
(35, 4, 15, 2, 'SSD (backup)'),
(36, 5, 3, 1, 'Drone principal de operacion'),
(37, 5, 10, 3, 'Baterias para drone'),
(38, 5, 14, 1, 'Tarjeta SD de respaldo'),
(39, 6, 3, 1, 'Drone principal de operacion'),
(40, 6, 10, 4, 'Baterias para bloques extendidos'),
(41, 6, 14, 2, 'Tarjetas SD (respaldo)'),
(42, 7, 1, 1, 'Camara para modulo photobooth'),
(43, 7, 5, 1, 'Tripode de soporte'),
(44, 7, 9, 1, 'Luz continua'),
(45, 7, 10, 2, 'Baterias base + 1 backup por servicio'),
(46, 7, 14, 1, 'Tarjeta SD (respaldo)'),
...
(69, 11, 1, 3, '2 camaras de operacion + 1 backup por servicio'),
...
(75, 11, 10, 3, 'Baterias base + respaldo por operacion'),
(77, 11, 14, 3, 'Tarjetas SD (respaldo)'),
...
(140, 21, 1, 4, '3 camaras de operacion + 1 de respaldo'),
(141, 21, 2, 4, 'Lentes por operador + respaldo'),
(142, 21, 4, 3, 'Flashes para cobertura completa'),
(143, 21, 5, 2, 'Tripodes de apoyo'),
(144, 21, 9, 2, 'Luces continuas de apoyo'),
(145, 21, 10, 4, 'Baterias base + respaldo'),
(146, 21, 12, 1, 'Monopode'),
(147, 21, 14, 4, 'Tarjetas SD (respaldo)'),
(148, 22, 1, 4, '2 camaras de operacion + 2 de respaldo'),
(149, 22, 6, 1, 'Gimbal principal'),
(150, 22, 8, 4, 'Microfonos para ceremonia y recepcion'),
(151, 22, 7, 1, 'Grabadora principal'),
(152, 22, 5, 2, 'Tripodes de operacion'),
(153, 22, 9, 2, 'Luces continuas de apoyo'),
(154, 22, 10, 4, 'Baterias base + respaldo'),
(155, 22, 12, 1, 'Monopode'),
(156, 22, 14, 4, 'Tarjetas SD (respaldo)'),
(157, 22, 15, 2, 'SSD (backup)');
ALTER TABLE `T_EventoServicioEquipo` AUTO_INCREMENT = 158;
...
(36, 22, 'Videografo', 2),
(37, 22, 'Asistente', 1);
ALTER TABLE `T_EventoServicioStaff` AUTO_INCREMENT = 38;
...
(26, 'WD'),
(27, 'Konova');
ALTER TABLE `T_Marca` AUTO_INCREMENT = 28;
...
ALTER TABLE `T_Modelo` AUTO_INCREMENT = 61;
