-- Schema export
-- Database: defaultdb
-- Generated at: 2026-02-18T21:19:16.748Z
...
CREATE TABLE "T_Contrato" (
  ...
  "Cont_Pdf_Link" varchar(255) DEFAULT NULL,
  "FK_P_Cod" int NOT NULL,
  "Cont_Version" int NOT NULL DEFAULT '1',
  "Cont_Estado" varchar(20) NOT NULL DEFAULT 'BORRADOR',
  "Cont_Snapshot" longtext,
  "Cont_SnapshotHash" char(64) DEFAULT NULL,
  "Cont_EsVigente" tinyint(1) NOT NULL DEFAULT '1',
  "Cont_Fecha_Crea" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "Cont_Fecha_Cierre" datetime DEFAULT NULL,
  PRIMARY KEY ("PK_Cont_Cod"),
  KEY "IX_T_Contrato_Pedido_Vigente" ("FK_P_Cod","Cont_EsVigente"),
  KEY "IX_T_Contrato_Pedido_Version" ("FK_P_Cod","Cont_Version"),
...
CREATE TABLE "T_Cotizacion" (
  ...
  "Cot_DatosEvento" json DEFAULT NULL,
...
DROP TABLE IF EXISTS `T_CotizacionEvento`;
...
DROP TABLE IF EXISTS `T_CotizacionServicio`;
...
DROP TABLE IF EXISTS `T_CotizacionServicioFecha`;
...
-- Table: T_CotizacionVersion
DROP TABLE IF EXISTS `T_CotizacionVersion`;
CREATE TABLE "T_CotizacionVersion" (
  ...
  "CotVer_Snapshot" longtext,
  "CotVer_SnapshotHash" char(64) DEFAULT NULL,
  "CotVer_EsVigente" tinyint(1) NOT NULL DEFAULT '1',
  "CotVer_Fecha_Crea" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "CotVer_Fecha_Cierre" datetime DEFAULT NULL,
  "CotVer_Pdf_Link" varchar(255) DEFAULT NULL,
  ...
  CONSTRAINT "FK_T_CotizacionVersion_T_Cotizacion" FOREIGN KEY ("FK_Cot_Cod") REFERENCES "T_Cotizacion" ("PK_Cot_Cod")
);
...
DROP TABLE IF EXISTS `T_Estado_Empleado`;
...
DROP TABLE IF EXISTS `T_Estado_Equipo`;
...
-- Table: T_Estado_Pago
DROP TABLE IF EXISTS `T_Estado_Pago`;
...
DROP TABLE IF EXISTS `T_Estado_Pedido`;
...
DROP TABLE IF EXISTS `T_Estado_Proyecto`;
...
DROP TABLE IF EXISTS `T_Estado_Proyecto_Dia`;
...
DROP TABLE IF EXISTS `T_Estado_voucher`;
...
DROP TABLE IF EXISTS `T_EventoServicio`;
...
DROP TABLE IF EXISTS `T_EventoServicioCategoria`;
...
DROP TABLE IF EXISTS `T_EventoServicioEquipo`;
...
DROP TABLE IF EXISTS `T_EventoServicioEstado`;
...
DROP TABLE IF EXISTS `T_EventoServicioStaff`;
...
CREATE TABLE "T_Eventos" (
  ...
  "E_FormSchema" json DEFAULT NULL,
...
CREATE TABLE "T_Pedido" (
  ...
  "P_DatosEvento" json DEFAULT NULL,
  "P_Lugar" varchar(150) DEFAULT NULL,
  "P_CierreFinancieroTipo" enum('NINGUNO','RETENCION_CANCEL_CLIENTE') NOT NULL DEFAULT 'NINGUNO',
  "P_CierreFinancieroMonto" decimal(10,2) DEFAULT NULL,
  "P_CierreFinancieroFecha" datetime DEFAULT NULL,
  "P_CierreFinancieroNotas" varchar(500) DEFAULT NULL,
  ...
  KEY "ix_pedido_cierre_financiero_tipo" ("P_CierreFinancieroTipo"),
...
DROP TABLE IF EXISTS `T_PedidoEvento`;
...
DROP TABLE IF EXISTS `T_PedidoServicio`;
...
DROP TABLE IF EXISTS `T_PedidoServicioFecha`;
...
DROP TABLE IF EXISTS `T_PortafolioImagen`;
...
-- Table: T_ProyectoDevolucionJob
DROP TABLE IF EXISTS `T_ProyectoDevolucionJob`;
CREATE TABLE "T_ProyectoDevolucionJob" (
  ...
  "PDJ_Result_JSON" json DEFAULT NULL,
  "PDJ_Error" varchar(500) DEFAULT NULL,
  "PDJ_Intentos" int NOT NULL DEFAULT '0',
  "PDJ_Started_At" datetime DEFAULT NULL,
  "PDJ_Completed_At" datetime DEFAULT NULL,
  "created_at" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Table: T_ProyectoDia
DROP TABLE IF EXISTS `T_ProyectoDia`;
CREATE TABLE "T_ProyectoDia" (
  ...
  "PD_MontoBase" decimal(10,2) DEFAULT NULL,
  "PD_Igv" decimal(10,2) DEFAULT NULL,
  "PD_MontoTotal" decimal(10,2) DEFAULT NULL,
  "PD_CancelResponsable" enum('CLIENTE','INTERNO') DEFAULT NULL,
  "PD_CancelMotivo" varchar(255) DEFAULT NULL,
  "PD_CancelNotas" varchar(500) DEFAULT NULL,
  "PD_CancelFecha" datetime DEFAULT NULL,
  "PD_NC_Requerida" tinyint(1) NOT NULL DEFAULT '0',
  "PD_NC_VoucherId" int DEFAULT NULL,
  "created_at" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  KEY "ix_proyecto_dia_nc_voucher" ("PD_NC_VoucherId"),
  CONSTRAINT "fk_proyecto_dia_estado" FOREIGN KEY ("FK_EPD_Cod") REFERENCES "T_Estado_Proyecto_Dia" ("PK_EPD_Cod"),
  CONSTRAINT "fk_proyecto_dia_nc_voucher" FOREIGN KEY ("PD_NC_VoucherId") REFERENCES "T_Voucher" ("PK_Pa_Cod") ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT "fk_proyecto_dia_proyecto" FOREIGN KEY ("FK_Pro_Cod") REFERENCES "T_Proyecto" ("PK_Pro_Cod")
);

-- Table: T_ProyectoDiaBloque
DROP TABLE IF EXISTS `T_ProyectoDiaBloque`;
...
DROP TABLE IF EXISTS `T_ProyectoDiaEmpleado`;
...
DROP TABLE IF EXISTS `T_ProyectoDiaEquipo`;
...
DROP TABLE IF EXISTS `T_ProyectoDiaIncidencia`;
...
DROP TABLE IF EXISTS `T_ProyectoDiaServicio`;
...
-- Table: T_Tipo_Equipo
DROP TABLE IF EXISTS `T_Tipo_Equipo`;
...
-- Table: T_UsuarioPerfil
DROP TABLE IF EXISTS `T_UsuarioPerfil`;
CREATE TABLE "T_UsuarioPerfil" (
  ...
  CONSTRAINT "FK_T_UsuarioPerfil_T_Perfil" FOREIGN KEY ("FK_Perf_Cod") REFERENCES "T_Perfil" ("PK_Perf_Cod") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "FK_T_UsuarioPerfil_T_Usuario" FOREIGN KEY ("FK_U_Cod") REFERENCES "T_Usuario" ("PK_U_Cod") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "T_Voucher" (
  ...
  "Pa_Monto_Depositado" decimal(10,2) NOT NULL,
...
CREATE VIEW "V_Pedido_Saldos" AS select "p"."PK_P_Cod" AS "PedidoId",coalesce("ev"."PrimerFecha","p"."P_Fecha_Creacion") AS "Fecha","p"."P_Fecha_Creacion" AS "FechaCreacion","pr"."Proyecto" AS "Proyecto",(coalesce("sv"."CostoTotal",0) + coalesce("p"."P_ViaticosMonto",0)) AS "CostoBase",round(((coalesce("sv"."CostoTotal",0) + coalesce("p"."P_ViaticosMonto",0)) * 0.18),2) AS "Igv",round(((coalesce("sv"."CostoTotal",0) + coalesce("p"."P_ViaticosMonto",0)) * 1.18),2) AS "CostoTotalOriginal",coalesce("pay"."CobrosPositivos",0) AS "CobrosPositivos",coalesce("pay"."NotasCredito",0) AS "NotasCredito",greatest((round(((coalesce("sv"."CostoTotal",0) + coalesce("p"."P_ViaticosMonto",0)) * 1.18),2) - coalesce("pay"."NotasCredito",0)),0) AS "CostoTotalNeto",greatest((round(((coalesce("sv"."CostoTotal",0) + coalesce("p"."P_ViaticosMonto",0)) * 1.18),2) - coalesce("pay"."NotasCredito",0)),0) AS "CostoTotal",coalesce("pay"."CobrosPositivos",0) AS "MontoAbonado",greatest((greatest((round(((coalesce("sv"."CostoTotal",0) + coalesce("p"."P_ViaticosMonto",0)) * 1.18),2) - coalesce("pay"."NotasCredito",0)),0) - coalesce("pay"."CobrosPositivos",0)),0) AS "SaldoPendiente","p"."FK_ESP_Cod" AS "EstadoPagoId","p"."FK_EP_Cod" AS "EstadoPedidoId" from (((("T_Pedido" "p" left join (select "T_PedidoServicio"."FK_P_Cod" AS "PedidoId",sum("T_PedidoServicio"."PS_Subtotal") AS "CostoTotal" from "T_PedidoServicio" group by "T_PedidoServicio"."FK_P_Cod") "sv" on(("sv"."PedidoId" = "p"."PK_P_Cod"))) left join (select "T_PedidoEvento"."FK_P_Cod" AS "PedidoId",min("T_PedidoEvento"."PE_Fecha") AS "PrimerFecha" from "T_PedidoEvento" group by "T_PedidoEvento"."FK_P_Cod") "ev" on(("ev"."PedidoId" = "p"."PK_P_Cod"))) left join (select "v"."FK_P_Cod" AS "PedidoId",round(sum((case when ("v"."Pa_Monto_Depositado" > 0) then "v"."Pa_Monto_Depositado" else 0 end)),2) AS "CobrosPositivos",round(sum((case when ("v"."Pa_Monto_Depositado" < 0) then abs("v"."Pa_Monto_Depositado") else 0 end)),2) AS "NotasCredito" from ("T_Voucher" "v" join "T_Estado_voucher" "ev2" on(("ev2"."PK_EV_Cod" = "v"."FK_EV_Cod"))) where ("ev2"."EV_Nombre" = 'Aprobado') group by "v"."FK_P_Cod") "pay" on(("pay"."PedidoId" = "p"."PK_P_Cod"))) left join (select "T_Proyecto"."FK_P_Cod" AS "PedidoId",max("T_Proyecto"."Pro_Nombre") AS "Proyecto" from "T_Proyecto" group by "T_Proyecto"."FK_P_Cod") "pr" on(("pr"."PedidoId" = "p"."PK_P_Cod")));
