...
(1, 1, 1, 1, 1, 'Fotografia Boda Premium', 'Cobertura integral de boda con direccion de retratos y entrega digital.', 'USD', 1800.00, 1, 0, 0, 'Estado expirada', 10.0, 2, 60, 0, 0);
-- T_CotizacionEvento
...
-- T_CotizacionServicio
INSERT INTO `T_CotizacionServicio` (`PK_CotServ_Cod`, `FK_Cot_Cod`, `FK_ExS_Cod`, `CS_EventoId`, `CS_ServicioId`, `CS_Nombre`, `CS_Descripcion`, `CS_Moneda`, `CS_PrecioUnit`, `CS_Cantidad`, `CS_Descuento`, `CS_Recargo`, `CS_Notas`, `CS_Horas`, `CS_Staff`, `CS_FotosImpresas`, `CS_TrailerMin`, `CS_FilmMin`) VALUES
(2, 2, 8, 2, 1, 'Fotografia Cumple Express', 'Servicio simple y economico: un fotografo, cobertura corta y entrega digital.', 'USD', 900.00, 1, 0, 0, 'Estado borrador', 4.0, 1, 0, NULL, NULL);
-- T_CotizacionEvento
INSERT INTO `T_CotizacionEvento` (`PK_CotE_Cod`, `FK_Cot_Cod`, `CotE_Fecha`, `CotE_Hora`, `CotE_Ubicacion`, `CotE_Direccion`, `CotE_Notas`) VALUES
...
INSERT INTO `T_CotizacionServicio` (`PK_CotServ_Cod`, `FK_Cot_Cod`, `FK_ExS_Cod`, `CS_EventoId`, `CS_ServicioId`, `CS_Nombre`, `CS_Descripcion`, `CS_Moneda`, `CS_PrecioUnit`, `CS_Cantidad`, `CS_Descuento`, `CS_Recargo`, `CS_Notas`, `CS_Horas`, `CS_Staff`, `CS_FotosImpresas`, `CS_TrailerMin`, `CS_FilmMin`) VALUES
(4, 4, 1, 1, 1, 'Fotografia Boda Premium', 'Cobertura integral de boda con direccion de retratos y entrega digital.', 'USD', 1800.00, 1, 0, 0, 'Regla 90 dias', 10.0, 2, 60, 0, 0),
(5, 5, 16, 3, 2, 'Video Corporativo Conferencia', 'Registro multicamara de conferencia con edicion de resumen.', 'USD', 3200.00, 1, 0, 0, 'Regla 7 dias', 6.0, 3, NULL, 2, 25),
(6, 6, 8, 2, 1, 'Fotografia Cumple Express', 'Servicio simple y economico: un fotografo, cobertura corta y entrega digital.', 'USD', 900.00, 1, 0, 0, 'Urgente', 4.0, 1, 0, NULL, NULL),
