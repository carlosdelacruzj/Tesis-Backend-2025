...
async function getAll(){ return runCall("CALL SP_getAllPedido()"); }
async function getIndex(){ return runCall("CALL SP_getIndexPedido()"); }

async function getById(id){
  const result = await runCall("CALL SP_getByIdPedido(?)",[id]); // ojo al nombre exacto del SP
