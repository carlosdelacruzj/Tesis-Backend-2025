...
// Módulos REST (todos se montan con /api/v1 desde app.js)
...
router.use("/cotizaciones", require("../modules/cotizacion/cotizacion.routes.rest")); // << aquí se agrega el prefijo
